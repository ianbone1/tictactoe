...
class Game(models.Model):
    ...
    def board(self):
        """Return a 2 dimensional list of Move objects so you can ask for the state of a square at positio [y][x]."""
    ...
    def new_move(self):
        ...
        if self.status not in 'FS':
            raise ValueError("Cannot make a move on finihsed game")
